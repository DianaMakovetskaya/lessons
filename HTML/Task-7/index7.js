...
// let newArray=cars.filter(value => value.volume>3);
// let newArray=cars.filter(value => value.volume===2);
// let newArray=cars.filter(value => value.producer==='mercedes');
// let newArray=cars.filter(value => value.volume>3&&value.producer==='mercedes');
// let newArray=cars.filter(value => value.volume>3&&value.producer==='subaru');
// let newArray=cars.filter(value => value.power>300);
// let newArray=cars.filter(value => value.power>300&&value.producer==='subaru');
// let newArray=cars.filter(value => value.engine.includes('ej'));
// let newArray=cars.filter(value => value.engine.includes('ej')&&value.power>300&&value.producer==='subaru');
// let newArray=cars.filter(value => value.volume<3&&value.producer==='mercedes');
// let newArray=cars.filter(value => value.volume>2&&value.power>250);
// let newArray=cars.filter(value => value.power>250&&value.producer==='bmw');
...
let usersWithAddress = [{id: 1, name: 'vasya', age: 31, status: false, address: {city: 'Lviv', street: 'Shevchenko', number: 16}}, {id: 2, name: 'petya', age: 30, status: true, address: {city: 'Lviv', street: 'Lypynskogo', number: 1}}, {id: 3, name: 'kolya', age: 29, status: true, address: {city: 'Lviv', street: 'Shevchenko', number: 121}}, {id: 4, name: 'olya', age: 28, status: false, address: {city: 'Lviv', street: 'Shevchenko', number: 90}}, {id: 5, name: 'max', age: 30, status: true, address: {city: 'Lviv', street: 'Shevchenko', number: 115}}, {id: 6, name: 'anya', age: 31, status: false, address: {city: 'Lviv', street: 'Shevchenko', number: 2}}, {id: 7, name: 'oleg', age: 28, status: false, address: {city: 'Lviv', street: 'Shevchenko', number: 22}}, {id: 8, name: 'andrey', age: 29, status: true, address: {city: 'Lviv', street: 'Shevchenko', number: 43}}, {id: 9, name: 'masha', age: 30, status: true, address: {city: 'Lviv', street: 'Shevchenko', number: 12}}, {id: 10, name: 'olya', age: 31, status: false, address: {city: 'Lviv', street: 'Shevchenko', number: 16}}, {id: 11, name: 'max', age: 31, status: true, address: {city: 'Lviv', street: 'Shevchenko', number: 121}}];
...
// let newUsers=usersWithAddress.filter(value => value.age<30);
// let newUsers=usersWithAddress.filter(value => value.status===false);
// let newUsers=usersWithAddress.filter(value => value.status===false && value.age<30);
// let newUsers=usersWithAddress.filter(value => value.address.number%2===0);
...
function Car(marka,power,price,year,name,age,experience){
    this.marka=marka;
    this.power=power;
    this.owner={
        name:name,
...
let car1= new Car('bmw',100,1200,2016,'ivan',19,2);
let car2= new Car('mers',150,2200,2017,'vasya',29,7);
let car3= new Car('mazda',250,4500,2015,'dima',17,6);
let car4= new Car('subaru',300,3200,2014,'sonya',31,1);
let car5= new Car('toyota',220,1000,2018,'liza',24,0);
let car6= new Car('porche',400,10200,2019,'diana',19,8);
let car7= new Car('ferrari',600,100200,2020,'yula',20,4);


let cars=[car1,car2,car3,car4,car5,car6,car7];
let remont=JSON.parse(JSON.stringify(cars));
